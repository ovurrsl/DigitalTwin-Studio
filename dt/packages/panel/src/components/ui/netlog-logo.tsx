...
export function NetlogLogo({
  className,
  title = 'Netlog Lojistik Grubu',
}: {
  className?: string
  title?: string
}) {
...
export function BrandLockup({
  ...
  return (
    <div className="flex min-w-0 items-center gap-[10px] overflow-hidden">
      ...
      {meta ? (
        <span className="whitespace-nowrap font-mono text-[9px] tracking-[0.14em] text-muted-fg">
          {meta}
        </span>
      ) : null}
    </div>
